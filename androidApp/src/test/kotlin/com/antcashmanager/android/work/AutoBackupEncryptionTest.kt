...
class AutoBackupEncryptionTest {
    ...
    @Test
    fun encryptionEnabled_shouldEncryptBackupData_whenSettingIsTrue() =
        runTest {
    ...
    @Test
    fun encryptionDisabled_shouldNotEncryptBackupData_whenSettingIsFalse() =
        runTest {
    ...
    @Test
    fun encryptionFailure_shouldPropagateError_whenCipherFails() =
        runTest {
            val plainBackupData = "{\"transactions\": []}"
            ...
            assertTrue(
                "Error message should indicate encryption issue",
                result.exceptionOrNull()?.message?.contains("Encryption") == true,
            )
        }

    @Test
    fun largeBackupData_shouldEncryptWithoutTimeout_whenSizeIsLarge() =
        runTest {
            val largeBackupData =
                buildString {
                    append("{\"transactions\": [")
    ...
    @Test
    fun encryptionSetting_shouldRespectCurrentValue_whenToggled() =
        runTest {
    ...
    @Test
    fun encryptedPayload_shouldContainCorrectPrefix_forIdentification() =
        runTest {
    ...
    @Test
    fun encryptionWithEmptyData_shouldHandleGracefully_whenBackupIsEmpty() =
        runTest {
            val emptyBackupData = "{}"
    ...
    @Test
    fun backupFlow_withEncryption_shouldChainCorrectly_throughAllSteps() =
        runTest {
            val backupData = "{\"transactions\": []}"
