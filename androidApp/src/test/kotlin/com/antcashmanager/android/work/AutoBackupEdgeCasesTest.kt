...
class AutoBackupEdgeCasesTest {
    ...
    @Test
    fun very_large_backup_with_10000_transactions_completes() = runTest {
    ...
    @Test
    fun extremely_large_backup_50000_transactions_succeeds() = runTest {
    ...
    @Test
    fun empty_backup_data_succeeds() = runTest {
    ...
    @Test
    fun backup_with_unicode_characters_succeeds() = runTest {
        val unicodeBackup = """
            {
              "transactions": [
    ...
    @Test
    fun backup_with_special_characters_in_content_succeeds() = runTest {
    ...
    @Test
    fun rapidly_triggered_backups_handled_gracefully() = runTest {
    ...
    @Test
    fun backup_with_very_long_transaction_title_succeeds() = runTest {
    ...
    @Test
    fun null_or_empty_folder_uri_fails_gracefully() = runTest {
    ...
    @Test
    fun malformed_json_backup_fails_gracefully() = runTest {
    ...
    private fun buildLargeBackup(transactionCount: Int): String {
        val transactions = (0 until transactionCount).joinToString(",") { i ->
