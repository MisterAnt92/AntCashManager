...
class ChartsViewModelTest : BaseUnitTest() {
     ...
     */
    @Test
    fun dailyTimelineAggregatesExpensesByDate() =
        runViewModelTest {
     ...
     */
    @Test
    fun expenseByWeekdayNormalizesCorrectly() =
        runViewModelTest {
            val cal = Calendar.getInstance()
     ...
     */
    @Test
    fun expenseByWeekdayIgnoresIncomeTransactions() =
        runViewModelTest {
            val cal = Calendar.getInstance()
            cal.set(2024, 0, 1, 12, 0, 0)
            val monday = cal.timeInMillis
     ...
     */
    @Test
    fun chartDataHandlesSmallDatasetsCorrectly() =
        runViewModelTest {
            val cal = Calendar.getInstance()
            cal.set(2024, 0, 1, 12, 0, 0)
