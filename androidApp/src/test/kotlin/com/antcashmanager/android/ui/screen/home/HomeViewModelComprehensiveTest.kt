...
class HomeViewModelComprehensiveTest : BaseUnitTest() {
    ...
    @Test
    fun transactions_shouldBeEmpty_whenRepositoryIsEmpty() =
        runViewModelTest {
            val collectJob =
                launch {
    ...
    @Test
    fun transactions_shouldShowAllTransactions_whenLoaded() =
        runViewModelTest {
    ...
    @Test
    fun transactions_shouldHandleLargeDataset() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            val transactions =
                (1..100).map { index ->
    ...
    @Test
    fun transactions_shouldPreserveUnicodeCharacters() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            fakeRepo.transactions.value =
                listOf(
    ...
    @Test
    fun transactions_shouldHandleMixedIncomeExpense() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            fakeRepo.transactions.value =
                listOf(
    ...
    @Test
    fun transactions_shouldHandleZeroAmountTransaction() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            fakeRepo.transactions.value =
                listOf(
    ...
    @Test
    fun transactions_shouldHandleRecurringTransactions() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            fakeRepo.transactions.value =
                listOf(
    ...
    @Test
    fun transactions_shouldHandleVeryLargeAmounts() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            fakeRepo.transactions.value =
                listOf(
    ...
    @Test
    fun transactions_shouldHandleComplexPayeeAndLocation() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            fakeRepo.transactions.value =
                listOf(
