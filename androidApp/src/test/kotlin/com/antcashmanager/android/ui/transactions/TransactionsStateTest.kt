...
class TransactionsStateTest {
    ...
    fun getDateFromForPreset_shouldReturnOneDayAgo_whenIndexIsZero() {
        assertApproximatelyAgo(TransactionsState.getDateFromForPreset(0), TransactionsConstant.ONE_DAY_MS)
    }

    @Test
    fun getDateFromForPreset_shouldReturnOneYearAgo_whenIndexIsThree() {
        assertApproximatelyAgo(TransactionsState.getDateFromForPreset(3), TransactionsConstant.ONE_YEAR_MS)
    }

    @Test
    fun getDateFromForPreset_shouldReturnTwoYearsAgo_whenIndexIsFour() {
        assertApproximatelyAgo(TransactionsState.getDateFromForPreset(4), TransactionsConstant.TWO_YEARS_MS)
    }

    @Test
    fun getDateFromForPreset_shouldReturnThreeYearsAgo_whenIndexIsFive() {
        assertApproximatelyAgo(TransactionsState.getDateFromForPreset(5), TransactionsConstant.THREE_YEARS_MS)
    }

    @Test
    fun getDateFromForPreset_shouldReturnFiveYearsAgo_whenIndexIsSix() {
        assertApproximatelyAgo(TransactionsState.getDateFromForPreset(6), TransactionsConstant.FIVE_YEARS_MS)
    }

    @Test
    fun getDateFromForPreset_shouldReturnSixYearsAgo_whenIndexIsSeven() {
        assertApproximatelyAgo(TransactionsState.getDateFromForPreset(7), TransactionsConstant.SIX_YEARS_MS)
    }
