...
class SettingsDataViewModelAutoBackupTest : BaseUnitTest() {
    ...
    @Test
    fun `when setAutoBackupEnabled is called with true, scheduler should schedule work`() =
        runUnitTest {
    ...
    @Test
    fun `when setAutoBackupEnabled is called with false, scheduler should cancel work`() =
        runUnitTest {
            val viewModel = createViewModel()
    ...
    @Test
    fun `when onAutoBackupFolderSelected is called, URI and enable should be persisted`() =
        runUnitTest {
            val viewModel = createViewModel()
    ...
    @Test
    fun `onAutoBackupFolderSelectionCancelled should not change state`() =
        runUnitTest {
            val viewModel = createViewModel()
    ...
    @Test
    fun `when onAutoBackupFolderSelected with invalid URI, should handle gracefully`() =
        runUnitTest {
            val viewModel = createViewModel()
    ...
    @Test
    fun `when folder permission is revoked, scheduler should cancel work`() =
        runUnitTest {
            val viewModel = createViewModel()
    ...
    @Test
    fun `when setAutoBackupEnabled is called multiple times, latest state wins`() =
        runUnitTest {
            val viewModel = createViewModel()
    ...
    @Test
    fun `when onAutoBackupFolderSelected is called twice, last URI is persisted`() =
        runUnitTest {
            val viewModel = createViewModel()
    ...
    @Test
    fun `when autoBackupEnabled is true, state should contain folder URI from repository`() =
        runUnitTest {
    ...
    @Test
    fun `when autoBackupEnabled but folder URI is null, should show not-selected state`() =
        runUnitTest {
