...
class TransactionsViewModelMockkTest : BaseUnitTest() {
    ...
    fun setup() {
        ...
        every { getTransactionsDateFilterStateUseCase() } returns
            flowOf(
                Result.success(
                    SavedDateFilter(
                        presetIndex = 1,
    ...
    @Test
    fun addTransaction_shouldCallInsertUseCase_whenInputIsValid() =
        runViewModelTest {
    ...
    @Test
    fun onEvent_shouldCallDeleteUseCase_whenDeleteTransactionEventArrives() =
        runViewModelTest {
            val viewModel = buildViewModel()
            val transaction =
                Transaction(
    ...
    @Test
    fun onEvent_shouldDelegateToUpdateUseCase_whenUpdateTransactionEventArrives() =
        runViewModelTest {
            val viewModel = buildViewModel()
            val transaction =
                Transaction(
    ...
    @Test
    fun addTransaction_shouldCompleteWithoutThrowing_whenInsertTransactionUseCaseFails() =
        runViewModelTest {
            coEvery { insertTransactionUseCase(any()) } returns
                Result.failure(
    ...
    @Test
    fun onEvent_shouldCompleteWithoutThrowing_whenUpdateTransactionUseCaseFails() =
        runViewModelTest {
            coEvery { updateTransactionUseCase(any()) } returns
                Result.failure(
                    IllegalStateException(
                        "update failed",
                    ),
    ...
    @Test
    fun onEvent_shouldCompleteWithoutThrowing_whenDeleteTransactionUseCaseFails() =
        runViewModelTest {
            coEvery { deleteTransactionUseCase(any()) } returns
                Result.failure(
                    IllegalStateException(
                        "delete failed",
                    ),
    ...
    @Test
    fun onEvent_shouldUpdateStateOptimistically_whenSetTransactionsDateFilterStateUseCaseFails() =
        runViewModelTest {
