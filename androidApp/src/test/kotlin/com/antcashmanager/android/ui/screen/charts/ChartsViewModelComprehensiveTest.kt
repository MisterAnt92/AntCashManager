...
class ChartsViewModelComprehensiveTest : BaseUnitTest() {
    ...
    @Test
    fun chartData_shouldBeEmpty_whenRepositoryIsEmpty() =
        runViewModelTest {
            val collectJob =
                launch {
    ...
    @Test
    fun chartData_shouldDisplayAllTransactions_whenLoaded() =
        runViewModelTest {
    ...
    @Test
    fun chartData_shouldAggregateByCategoryCorrectly() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            fakeRepo.transactions.value =
                listOf(
    ...
    @Test
    fun chartData_shouldSeparateIncomeAndExpense() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            fakeRepo.transactions.value =
                listOf(
    ...
    @Test
    fun chartData_shouldHandleLargeDataset() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            val transactions =
                (1..100).map { index ->
    ...
    @Test
    fun dateRange_shouldDefaultToLastMonth() =
        runViewModelTest {
            val collectJob =
                launch {
    ...
    @Test
    fun setDateRange_shouldUpdateState() =
        runViewModelTest {
            val now = System.currentTimeMillis()
    ...
    @Test
    fun setDateRange_shouldNormalizeFromAndTo_whenFromIsGreater() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            val from = now
    ...
    @Test
    fun setPresetRange_shouldSetWeekPreset() =
        runViewModelTest {
            val collectJob =
                launch {
    ...
    @Test
    fun setPresetRange_shouldSetMonthPreset() =
        runViewModelTest {
            val collectJob =
                launch {
                    viewModel.selectedPresetIndex.collect {}
    ...
    @Test
    fun setPresetRange_shouldSetYearPreset() =
        runViewModelTest {
            val collectJob =
                launch {
                    viewModel.selectedPresetIndex.collect {}
    ...
    @Test
    fun selectChartCategory_shouldSetDetails() =
        runViewModelTest {
            val collectJob =
                launch {
    ...
    @Test
    fun selectChartCategory_shouldCalculatePercentageCorrectly() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            fakeRepo.transactions.value =
                listOf(
    ...
    @Test
    fun clearChartSelection_shouldSetDetailsToNull() =
        runViewModelTest {
            val collectJob =
                launch {
                    viewModel.selectedChartDetails.collect {}
    ...
    @Test
    fun chartData_shouldHandleMultipleCategories_inIncomeAndExpense() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            fakeRepo.transactions.value =
                listOf(
    ...
    @Test
    fun chartData_shouldHandleZeroAmountTransactions() =
        runViewModelTest {
            val now = System.currentTimeMillis()
            fakeRepo.transactions.value =
                listOf(
    ...
    @Test
    fun monthlyData_shouldBeAggregatedCorrectly() =
        runViewModelTest {
            val now = System.currentTimeMillis()
