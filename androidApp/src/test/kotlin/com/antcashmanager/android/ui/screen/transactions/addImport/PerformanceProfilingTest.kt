...
class PerformanceProfilingTest : BaseUnitTest() {
    ...
    @Test
    fun `performance measure loadCategories operation`() =
        runUnitTest {
    ...
    @Test
    fun `performance measure loadMealVoucherValue operation`() =
        runUnitTest {
    ...
    @Test
    fun `performance measure transaction validation`() =
        runUnitTest {
    ...
    @Test
    fun `performance measure suggestions filtering`() =
        runUnitTest {
            val getSuggestionsUC =
    ...
    @Test
    fun `performance measure database operations`() =
        runUnitTest {
            val insertUC = InsertTransactionUseCase(transactionRepository, testDispatcher)
            val updateUC = UpdateTransactionUseCase(transactionRepository, testDispatcher)
