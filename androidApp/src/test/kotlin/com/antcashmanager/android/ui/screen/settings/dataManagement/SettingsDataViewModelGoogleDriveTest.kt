...
class SettingsDataViewModelGoogleDriveTest : BaseUnitTest() {
    ...
    @Test
    fun `setAutoBackupDestination_toGoogleDrive_notSignedIn_showsDialog`() = runUnitTest {
    ...
    @Test
    fun `setAutoBackupDestination_toGoogleDrive_alreadySignedIn_noDialog`() = runUnitTest {
    ...
    @Test
    fun `setAutoBackupDestination_toLocal_closesDialog`() = runUnitTest {
    ...
    @Test
    fun `initiateGoogleSignIn_success_updatesState`() = runUnitTest {
    ...
    @Test
    fun `initiateGoogleSignIn_failure_rollsBackToLocal`() = runUnitTest {
        // Setup: sign-in fails
    ...
    @Test
    fun `signOutFromGoogle_success_clearsState`() = runUnitTest {
    ...
    @Test
    fun `signOutFromGoogle_failure_stillHandled`() = runUnitTest {
    ...
    @Test
    fun `fullSignInFlow_selectGoogleDrive_signIn_success`() = runUnitTest {
        // Setup
        val testEmail = "user@example.com"
        val signInResult = GoogleSignInResult(
            email = testEmail,
    ...
    @Test
    fun `fullSignOutFlow_googleDrive_signOut_success`() = runUnitTest {
