...
public class SetChartsDateFilterStateUseCase(
    private val settingsRepository: SettingsRepository,
    dispatcher: CoroutineDispatcher = Dispatchers.Default,
) : UseCase<SavedDateFilter, Unit>(dispatcher) {
    override suspend fun execute(params: SavedDateFilter): Unit = settingsRepository.setChartsDateFilterState(params)
}
