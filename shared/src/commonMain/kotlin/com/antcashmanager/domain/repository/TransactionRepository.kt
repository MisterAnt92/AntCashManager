...
public interface TransactionRepository {
     ...
     */
    public fun getTransactionsPaginated(pageSize: Int = 100, pageIndex: Int = 0): Flow<List<Transaction>>
     ...
     */
    public fun getTransactionsByCategory(category: String, pageSize: Int = 100, pageIndex: Int = 0): Flow<List<Transaction>>

    /**
     * Search transactions by query text (title/payee/notes).
     * Database-level full-text equivalent for efficiency.
     */
    public fun searchTransactions(query: String, pageSize: Int = 100, pageIndex: Int = 0): Flow<List<Transaction>>
    ...
    public fun getTransactionsByDateRange(from: Long, to: Long): Flow<List<Transaction>>
