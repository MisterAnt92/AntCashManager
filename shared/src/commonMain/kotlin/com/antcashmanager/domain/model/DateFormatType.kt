 ...
 */
public enum class DateFormatType(public val pattern: String) {
    ...
    public companion object {
         ...
         */
        public val SUPPORTED_FORMATS: List<Pair<DateFormatType, String>> = listOf(
         ...
         */
        public fun fromPattern(pattern: String): DateFormatType =
