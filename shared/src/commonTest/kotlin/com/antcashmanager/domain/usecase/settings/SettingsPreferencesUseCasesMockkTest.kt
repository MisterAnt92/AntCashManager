...
class SettingsPreferencesUseCasesMockkTest {
    ...
    @Test
    fun getShowChartsUseCase_shouldDelegateToRepository() = runTest {
    ...
    @Test
    fun setShowChartsUseCase_shouldPassBooleanToRepository() = runTest {
    ...
    @Test
    fun getHighContrastUseCase_shouldDelegateToRepository() = runTest {
    ...
    @Test
    fun setHighContrastUseCase_shouldPassBooleanToRepository() = runTest {
    ...
    @Test
    fun getLargeTextUseCase_shouldDelegateToRepository() = runTest {
    ...
    @Test
    fun setLargeTextUseCase_shouldPassBooleanToRepository() = runTest {
    ...
    @Test
    fun getReduceMotionUseCase_shouldDelegateToRepository() = runTest {
    ...
    @Test
    fun setReduceMotionUseCase_shouldPassBooleanToRepository() = runTest {
    ...
    @Test
    fun getShowTransactionNotesUseCase_shouldDelegateToRepository() = runTest {
    ...
    @Test
    fun setShowTransactionNotesUseCase_shouldPassBooleanToRepository() = runTest {
    ...
    @Test
    fun getCurrencySymbolUseCase_shouldDelegateToRepository() = runTest {
    ...
    @Test
    fun setCurrencySymbolUseCase_shouldPassStringToRepository() = runTest {
    ...
    @Test
    fun getDecimalSeparatorUseCase_shouldDelegateToRepository() = runTest {
    ...
    @Test
    fun setDecimalSeparatorUseCase_shouldPassStringToRepository() = runTest {
    ...
    @Test
    fun getThousandsSeparatorUseCase_shouldDelegateToRepository() = runTest {
    ...
    @Test
    fun setThousandsSeparatorUseCase_shouldPassStringToRepository() = runTest {
    ...
    @Test
    fun getDecimalDigitsUseCase_shouldDelegateToRepository() = runTest {
    ...
    @Test
    fun setDecimalDigitsUseCase_shouldPassIntToRepository() = runTest {
    ...
    @Test
    fun setTransactionDisplayTypeUseCase_shouldPassEnumToRepository() = runTest {
    ...
    @Test
    fun setTutorialCompletedUseCase_shouldPassBooleanToRepository() = runTest {
    ...
    @Test
    fun resetAllPreferencesUseCase_shouldDelegateToRepository() = runTest {
