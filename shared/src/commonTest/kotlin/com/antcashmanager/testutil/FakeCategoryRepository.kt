...
/**
 * Fake unico e completo di [CategoryRepository] per i test, backed da un'unica
 * sorgente reattiva ([categories]). `open` per permettere override puntuali nei
 * rari casi con comportamento unico invece di duplicare l'intero fake.
 */
