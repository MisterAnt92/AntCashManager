...
/**
 * Fake unico e completo di [SettingsRepository] per i test.
 *
 ...
 * introdotta da una futura modifica al ViewModel/UseCase non rompe i test
 * esistenti. Per personalizzare un valore in un test basta assegnare `.value`
 * al campo corrispondente, prima o dopo la creazione del ViewModel.
 */
open class FakeSettingsRepository : SettingsRepository {
    ...
    override suspend fun resetAllPreferences() {
        ...
        chartCardsOrder.value = ""
        homeTopCardsOrder.value = ""
    }
}
