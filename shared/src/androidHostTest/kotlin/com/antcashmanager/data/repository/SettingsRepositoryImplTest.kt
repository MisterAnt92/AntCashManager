...
class SettingsRepositoryImplTest {
    ...
    @Test
    fun getTheme_shouldReturnSystem_whenNoThemeIsStored() =
        runTest {
            assertEquals(AppTheme.SYSTEM, repository.getTheme().first())
        }

    @Test
    fun getTheme_shouldFallbackToSystem_whenStoredThemeIsInvalid() =
        runTest {
    ...
    @Test
    fun getLanguage_shouldFallbackToSystem_whenStoredLanguageIsInvalid() =
        runTest {
    ...
    @Test
    fun getTransactionDisplayType_shouldFallbackToTrend_whenStoredValueIsInvalid() =
        runTest {
    ...
    @Test
    fun setTheme_shouldPersistAndBeReadableViaGetTheme_whenCalled() =
        runTest {
    ...
    @Test
    fun getHomeDateFilterState_shouldReturnNormalizedDefault_whenNothingStored() =
        runTest {
    ...
    @Test
    fun setHomeDateFilterState_shouldNormalizeFromAndTo_whenFromIsAfterTo() =
        runTest {
    ...
    @Test
    fun setTransactionsDateFilterState_shouldNormalizeFromAndTo_whenFromIsAfterTo() =
        runTest {
    ...
    @Test
    fun setChartsDateFilterState_shouldNormalizeFromAndTo_whenFromIsAfterTo() =
        runTest {
    ...
    @Test
    fun resetAllPreferences_shouldRestoreAllDefaultsAndDisableEncryption_whenCalled() =
        runTest {
            repository.setTheme(AppTheme.DARK)
    ...
    @Test
    fun getShowCharts_shouldReturnDefaultTrue_whenNotStored() =
        runTest {
            assertEquals(true, repository.getShowCharts().first())
        }

    @Test
    fun setShowCharts_shouldPersistBooleanValue_whenToggled() =
        runTest {
    ...
    @Test
    fun getHighContrast_shouldReturnDefaultFalse_whenNotStored() =
        runTest {
            assertEquals(false, repository.getHighContrast().first())
        }

    @Test
    fun setHighContrast_shouldPersistBooleanValue_whenToggled() =
        runTest {
    ...
    @Test
    fun getLargeText_shouldReturnDefaultFalse_whenNotStored() =
        runTest {
            assertEquals(false, repository.getLargeText().first())
        }

    @Test
    fun setLargeText_shouldPersistBooleanValue_whenToggled() =
        runTest {
    ...
    @Test
    fun getReduceMotion_shouldReturnDefaultFalse_whenNotStored() =
        runTest {
            assertEquals(false, repository.getReduceMotion().first())
        }

    @Test
    fun setReduceMotion_shouldPersistBooleanValue_whenToggled() =
        runTest {
    ...
    @Test
    fun getCurrencySymbol_shouldReturnDefaultEuro_whenNotStored() =
        runTest {
            assertEquals("€", repository.getCurrencySymbol().first())
        }

    @Test
    fun setCurrencySymbol_shouldPersistCustomSymbol_whenSet() =
        runTest {
            repository.setCurrencySymbol("$")
    ...
    @Test
    fun getDecimalDigits_shouldReturnDefault2_whenNotStored() =
        runTest {
            assertEquals(2, repository.getDecimalDigits().first())
        }

    @Test
    fun setDecimalDigits_shouldPersistCustomValue_whenSet() =
        runTest {
    ...
    @Test
    fun getDecimalSeparator_shouldReturnDefaultComma_whenNotStored() =
        runTest {
            assertEquals(",", repository.getDecimalSeparator().first())
        }

    @Test
    fun setDecimalSeparator_shouldPersistCustomValue_whenSet() =
        runTest {
    ...
    @Test
    fun getThousandsSeparator_shouldReturnDefaultDot_whenNotStored() =
        runTest {
            assertEquals(".", repository.getThousandsSeparator().first())
        }

    @Test
    fun setThousandsSeparator_shouldPersistCustomValue_whenSet() =
        runTest {
    ...
    @Test
    fun getMealVoucherValue_shouldReturnDefault5_29_whenNotStored() =
        runTest {
            assertEquals(5.29, repository.getMealVoucherValue().first(), 0.001)
        }

    @Test
    fun setMealVoucherValue_shouldPersistCustomValue_whenSet() =
        runTest {
    ...
    @Test
    fun getDateFormat_shouldReturnDefaultDDMMYYYY_whenNotStored() =
        runTest {
            assertEquals("dd/MM/yyyy", repository.getDateFormat().first())
        }

    @Test
    fun setDateFormat_shouldPersistCustomFormat_whenSet() =
        runTest {
    ...
    @Test
    fun getSuggestionsEnabled_shouldReturnDefaultTrue_whenNotStored() =
        runTest {
            assertEquals(true, repository.getSuggestionsEnabled().first())
        }

    @Test
    fun setSuggestionsEnabled_shouldPersistBooleanValue_whenToggled() =
        runTest {
    ...
    @Test
    fun getLastBackupTimestamp_shouldReturnDefault0_whenNotStored() =
        runTest {
            assertEquals(0L, repository.getLastBackupTimestamp().first())
        }

    @Test
    fun setLastBackupTimestamp_shouldPersistTimestamp_whenSet() =
        runTest {
    ...
    @Test
    fun getShowQuickInsightsCard_shouldReturnDefaultTrue_whenNotStored() =
        runTest {
            assertEquals(true, repository.getShowQuickInsightsCard().first())
        }

    @Test
    fun setShowQuickInsightsCard_shouldPersistBooleanValue_whenToggled() =
        runTest {
    ...
    @Test
    fun getWidgetBackgroundColor_shouldReturnDefaultBlack_whenNotStored() =
        runTest {
            assertEquals(-16777216L, repository.getWidgetBackgroundColor().first())
        }

    @Test
    fun setWidgetBackgroundColor_shouldPersistCustomColor_whenSet() =
        runTest {
    ...
    @Test
    fun getWidgetOpacity_shouldReturnDefault100_whenNotStored() =
        runTest {
    ...
    @Test
    fun setWidgetOpacity_shouldPersistCustomValue_whenSet() =
        runTest {
