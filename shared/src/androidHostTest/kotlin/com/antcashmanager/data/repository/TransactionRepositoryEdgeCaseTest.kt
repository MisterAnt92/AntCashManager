...
class TransactionRepositoryEdgeCaseTest {
    ...
    @Test
    fun transactionRepository_withEmptyDatabase_shouldReturnEmptyList() = runTest {
    ...
    @Test
    fun transactionRepository_shouldPreserveTitleWithSpecialCharacters() = runTest {
    ...
    @Test
    fun transactionRepository_shouldHandleVeryLongTitle() = runTest {
    ...
    @Test
    fun transactionRepository_shouldHandleExtremelyLargeAmount() = runTest {
    ...
    @Test
    fun transactionRepository_shouldHandleNegativeAmountBoundary() = runTest {
    ...
    @Test
    fun transactionRepository_shouldHandleZeroAmount() = runTest {
        val transaction = testTransaction {
            amount = 0.0
        }
    ...
    @Test
    fun transactionRepository_shouldPreservePayeeWithSpecialChars() = runTest {
        val transaction = testTransaction {
    ...
    @Test
    fun transactionRepository_shouldPreserveLocationWithComplexFormat() = runTest {
        val transaction = testTransaction {
    ...
    @Test
    fun transactionRepository_shouldPreserveTagsWithHashSymbol() = runTest {
        val transaction = testTransaction {
    ...
    @Test
    fun transactionRepository_shouldHandleNotesWithLineBreaks() = runTest {
        val transaction = testTransaction {
            notes = "Line 1\nLine 2\nLine 3"
            amount = -50.0
        }
    ...
    @Test
    fun transactionRepository_shouldHandleRecurringWithValidInterval() = runTest {
        val transaction = testTransaction {
            isRecurring = true
    ...
    @Test
    fun transactionRepository_shouldHandleNonRecurringWithEmptyInterval() = runTest {
        val transaction = testTransaction {
            isRecurring = false
            recurrenceInterval = ""
            amount = -50.0
    ...
    @Test
    fun transactionRepository_shouldPreserveMealVoucherCount() = runTest {
        val transaction = testTransaction {
            mealVoucherCount = 5
            amount = -50.0
        }
    ...
    @Test
    fun transactionRepository_shouldHandleZeroMealVouchers() = runTest {
        val transaction = testTransaction {
            mealVoucherCount = 0
            amount = -50.0
        }
    ...
    @Test
    fun transactionRepository_shouldPreserveCategoryIcon() = runTest {
        val transaction = testTransaction {
    ...
    @Test
    fun transactionRepository_shouldPreserveCategoryColor() = runTest {
        val transaction = testTransaction {
    ...
    @Test
    fun transactionRepository_shouldHandleAllPaymentTypes() = runTest {
    ...
    @Test
    fun transactionRepository_shouldHandleAllTransactionTypes() = runTest {
    ...
    @Test
    fun transactionRepository_shouldPreserveDecimalPrecision() = runTest {
        val transaction = testTransaction {
            amount = -19.99
        }
    ...
    @Test
    fun transactionRepository_shouldHandleLargeDecimalValues() = runTest {
        val transaction = testTransaction {
            amount = 12345.6789
        }
