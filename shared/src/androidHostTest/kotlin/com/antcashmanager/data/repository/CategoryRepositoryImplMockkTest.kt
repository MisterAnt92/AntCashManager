...
class CategoryRepositoryImplMockkTest {
    ...
    @Test
    fun getAllCategories_shouldMapEntitiesToDomain_whenDaoEmitsCategories() =
        runTest {
    ...
    @Test
    fun getAllCategories_shouldMapSortOrderAndIsHidden_whenEntityHasNonDefaultValues() =
        runTest {
    ...
    @Test
    fun getCategoryByName_shouldReturnMappedCategory_whenDaoReturnsEntity() =
        runTest {
    ...
    @Test
    fun getCategoryByName_shouldReturnNull_whenDaoReturnsNull() =
        runTest {
    ...
    @Test
    fun deleteCategory_shouldNotCallDao_whenCategoryIsDefault() =
        runTest {
    ...
    @Test
    fun deleteCategory_shouldCallDao_whenCategoryIsNotDefault() =
        runTest {
    ...
    @Test
    fun deleteAllCategories_shouldDeleteOnlyNonDefaultCategories_whenCalled() =
        runTest {
    ...
    @Test
    fun getCategoryById_shouldReturnMappedCategory_whenDaoReturnsEntity() =
        runTest {
    ...
    @Test
    fun getCategoryById_shouldReturnNull_whenDaoReturnsNull() =
        runTest {
    ...
    @Test
    fun insertCategory_shouldCallDaoAndReturnCategoryId_whenCategoryProvided() =
        runTest {
    ...
    @Test
    fun updateCategory_shouldCallDaoWithMappedEntity_whenCategoryProvided() =
        runTest {
    ...
    @Test
    fun getCategoriesByType_shouldReturnMappedCategoriesFilteredByType_whenDaoEmitsEntities() =
        runTest {
            val expenseEntity =
                sampleEntity(id = 6L, name = "Transport", sortOrder = 1)
                    .copy(type = "EXPENSE")
            val incomeEntity =
                sampleEntity(id = 7L, name = "Salary", sortOrder = 0)
                    .copy(type = "INCOME")
    ...
    @Test
    fun getDefaultCategoryCount_shouldReturnCountOfDefaultCategories_whenQueried() =
        runTest {
    ...
    @Test
    fun updateCategory_shouldPreserveAllFields_whenCategoryHasComplexData() =
        runTest {
            val category =
                sampleCategory(
                    id = 8L,
