...
class GetTransactionsUseCaseTest {
    ...
    @Test
    fun invokeReturnsAllTransactionsFromRepository() =
        runTest {
    ...
    @Test
    fun invokeReturnsEmptyListWhenRepositoryHasNoTransactions() =
        runTest {
    ...
    @Test
    fun returnedTransactionsContainCorrectTypes() =
        runTest {
            val result = useCase().first().getOrThrow()
    ...
    @Test
    fun invokeReflectsRepositoryUpdatesReactively() =
    ...
    @Test
    fun invokeWithStandardTestDispatcherRequiresAdvanceUntilIdle() =
        runTest(testDispatcher) {
            val repository = FakeTransactionRepository(sampleTransactions)
    ...
    @Test
    fun flowCollection_shouldBeCancellable() =
        runTest(testDispatcher) {
            val repository = FakeTransactionRepository(sampleTransactions)
