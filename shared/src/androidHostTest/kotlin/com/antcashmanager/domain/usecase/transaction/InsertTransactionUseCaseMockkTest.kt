...
class InsertTransactionUseCaseMockkTest {
    ...
    fun setup() {
        ...
        useCase = InsertTransactionUseCase(
    ...
    @Test
    fun invoke_shouldReturnSuccessId_whenRepositoryInsertSucceeds() = runTest(testDispatcher) {
    ...
    @Test
    fun invoke_shouldReturnFailure_whenRepositoryInsertThrows() = runTest(testDispatcher) {
    ...
    @Test
    fun invoke_shouldForwardTransactionToRepository_whenCalled() = runTest(testDispatcher) {
