...
class GetThemeUseCaseTest {
    ...
    @Test
    fun invokeReturnsSYSTEMThemeByDefault() = runTest {
        val theme = useCase().first().getOrThrow()
        assertEquals(AppTheme.SYSTEM, theme)
    }

    @Test
    fun invokeReturnsDARKAfterSettingDarkTheme() = runTest {
    ...
    @Test
    fun invokeReturnsLIGHTAfterSettingLightTheme() = runTest {
...
class SetThemeUseCaseTest {
    ...
    @Test
    fun invokeSetsThemeToDARK() = runTest {
    ...
    @Test
    fun invokeSetsThemeToLIGHT() = runTest {
    ...
    @Test
    fun invokeChangesThemeFromDARKToSYSTEM() = runTest {
        setThemeUseCase(AppTheme.DARK)
