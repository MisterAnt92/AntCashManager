# Multilingual Assets Report

**Generated on:** 2026-05-25  
**Project:** AntCashManager  
**Languages:** `it`, `en`, `de`, `fr`, `es`

## What was generated

- Feature graphic localized (`1024x500`): SVG + PNG + JPG for 5 languages.
- Promo graphic localized (`180x120`): SVG + PNG + JPG for 5 languages.
- Twitter banner localized (`1500x500`): SVG + PNG + JPG for 5 languages.

Total localized files generated: **45**

- `store-assets/feature-graphics/localized/`: 15 files
- `store-assets/promo-graphics/localized/`: 15 files
- `social-assets/twitter-banner/localized/`: 15 files
...
- `extra/icons/store-assets/feature-graphics/localized/fr/feature-graphic-1024x500.png`
...
- `extra/icons/store-assets/promo-graphics/localized/fr/promo-180x120.png`
...
- `extra/icons/social-assets/twitter-banner/localized/fr/twitter-banner-1500x500.png`
- `extra/icons/social-assets/twitter-banner/localized/es/twitter-banner-1500x500.png`

## Dimension verification

All localized PNG/JPG outputs were verified with `identify`:

- Feature graphics: `1024x500`
- Promo graphics: `180x120`
- Twitter banners: `1500x500`
